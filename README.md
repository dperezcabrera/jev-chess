...
| POST | `/api/takeback` | `{"ply": 52}` optional | Take your last move back with the model's reply, or go back to a position where it is your move; the record counts the takebacks |
